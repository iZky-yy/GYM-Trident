...
@section('content')
    <div class="content">
        <div class="form-container">
            <h2 class="form-title">Edit Personal Trainer</h2>
            <form action="{{ route('personaltrainer.update', $pts->id )}}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
